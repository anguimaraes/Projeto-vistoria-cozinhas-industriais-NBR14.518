            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Usuário Cadastrado com sucesso!</h4>
                    </div>
                    <div class="modal-body">
                        <p>Deseja cadastrar um novo usuário?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default"><a href="formCadastroUsuario.php">Cadastrar novo usuário</a></button>

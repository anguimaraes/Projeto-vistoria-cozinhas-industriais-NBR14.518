            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Agendamento cadastrado com sucesso!</h4>
                    </div>
                    <div class="modal-body">
                        <p>Deseja cadastrar um novo agendamento?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default"><a href="escolhaShop.php">Cadastrar novo agendamento</a></button>
